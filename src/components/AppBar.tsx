...
export const AppBar = (): JSX.Element => (
  <nav className="fixed inset-x-0 top-0 z-50 flex items-center h-16 px-2 overflow-x-auto text-gray-100 shadow-lg lg:px-4 navbar justify-items-center bg-gradient-to-br from-teal-600 to-blue-400">
    <img
    ...
    <NavLink exact to="/" className="ml-4 lg:ml-8">
      Home
    </NavLink>
